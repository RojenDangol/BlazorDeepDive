    ...
    public class ServerManagementContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Server>().HasData(
                ...
                new Server { ServerId = 8, Name = "Server8", City = "Ottawa", IsOnline = false },
                new Server { ServerId = 9, Name = "Server9", City = "Ottawa", IsOnline = true },
                ...
                new Server { ServerId = 14, Name = "Server14", City = "Halifax", IsOnline = false },
